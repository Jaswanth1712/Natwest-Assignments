...
this.travelType=travelType;
    ...
    */
    ...
    public String getTravellerDetails() {
         ...
         int idx=getId();
         String travelTypex=getTravelType();
         double pricex=getPrice();
         List<String> locationsx=getLocations();


         return "traveller{"+"id="+idx+", "+"price="+pricex+", "+"travelType='"+travelTypex+"', "+"locations="+locationsx+"}";
